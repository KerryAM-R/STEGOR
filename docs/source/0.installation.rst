...
1. From the github repository `STEGO.R <https://github.com/KerryAM-R/STEGO.R>`_ 
   ...
   a. Download the `Directory_for_Project.zip <https://raw.githubusercontent.com/KerryAM-R/STEGO.R/main/Directory_for_Project.zip>`_
   b. Unzip the Directory_for_Project 
   c. Rename the folder if desired. 
