...
Also, there is a "TCR" annotation section that identifies the human unconcentional T cells: MAIT, iNKT, gamma-delta T cells, and possible CD1c restricted (mouse is under development). 

If you dont select all a
...
1. Design your custom marker set bas
